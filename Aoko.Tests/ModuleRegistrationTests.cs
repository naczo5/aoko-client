...
public class ModuleRegistrationTests
{
    ...
    private static bool TrySetDiscordEnabled(Clicker clicker, string moduleId, bool enabled)
    {
        switch (moduleId)
        {
            ...
            case "refill": clicker.RefillEnabled = enabled; return true;
            ...
            case "throwpot": clicker.ThrowpotEnabled = enabled; return true;
            case "autoheal": clicker.AutoHealEnabled = enabled; return true;
