...
public static class ModuleCatalog
{
    ...
    [
        ...
        new("refill", "Refill", "cfg.refill", c => c.RefillEnabled),
        ...
        new("throwpot", "Throwpot", "cfg.throwpotEnabled", c => c.ThrowpotEnabled),
        new("autoheal", "AutoHeal", "cfg.autoHealEnabled", c => c.AutoHealEnabled),
