        ...
        if (is121 || is261)
        {
            return new BridgeCapabilities(
                BuildSet(
                    ...
                    "cheststealerenabled",
                    "cheststealerdelayms",
                    "cheststealermenucheck",
                    "cheststealertitlecheck",
                    "cheststealercustomitemscheck",
                    "cheststealerphysicalcheck",
                    "refillenabled",
                    "refilldelayms",
                    "throwpotenabled",
                    "keybindthrowpot",
                    ...
                    "autorodenabled",
                    "autorodslotmode",
                    "autorodverifyforcedslot",
                    "autorodextensionticks",
                    "autorodholdtoextend",
                    "keybindautorod",
                    "autotoolenabled",
                    "autotoolswapweapon",
                    ...
                    "autotoolswaptodelay",
                    "autotoolswapback",
                    "autotoolswapbackdelay",
                    "autotoolrequiremousedown",
                    "autotoolonlysneaking",
                    "autotoolbedwarsmode",
                    "keybindautotool",
                    "antidebuffenabled",
                    "hitdelayfixenabled",
