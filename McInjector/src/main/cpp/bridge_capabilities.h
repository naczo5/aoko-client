...
inline const char* ModernCapabilitiesJson()
{
    return
        "{\"type\":\"capabilities\","
        "\"modules\":[\"autoclicker\",\"rightclick\",\"jitter\",\"clickinchests\",\"breakblocks\",\"aimassist\",\"triggerbot\",\"silentaura\",\"speedbridge\",\"gtbhelper\",\"nametags\",\"closestplayer\",\"chestesp\",\"cheststealer\",\"blockesp\",\"reach\",\"velocity\",\"autototem\",\"antidebuff\",\"pixelpartyassist\",\"hudeditor\"],"
