...
- Bindable actions include: autoclicker, right-click, aim assist, triggerbot, speedbridge, GTB helper, PixelParty assist, nametags, closest player, fight status, chest ESP, chest stealer, block ESP, reach, velocity, autototem, HUD editor, and **panic**.
